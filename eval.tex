...
The \inbox schedules traffic using stochastic fair queueing~\cite{sfq} in our experiments. We additionally evaluated other scheduling policies. 
For example, with CoDel~\cite{fq-codel}, \name can achieve 97\% lower median end-to-end RTTs and 89\% lower 99\%ile RTTs.
