...
\end{enumerate}
\radhika{The rest of this section ...}
...
\radhika{maybe add a line or two on choice of congestion control at \name}
\cut{
...
This violates requirement (3): it requires stateful operations at high line rates \radhika{any citation on why stateful difficult?}.
...
\radhika{why is this interesting to discuss (e.g. is there a trade-off between in-band and out-band, or is the latter unanimously better? also, not all encap/decap will lead to these issues, so need to be more explicit. another way to pitch it is to say we use an out-of-band approac}