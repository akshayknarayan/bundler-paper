...
Our evaluation, on real Internet paths and on a variety of emulated scenarios, shows that in a scenario with self-inflicted scheduling overhead, \name achieves 33\% lower median normalized flow completion time than the status quo scenario with queueing in the middle of the network.
\end{abstract}
