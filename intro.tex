...
So while network operators do not have enough visibility into the traffic to choose the appropriate policy, the customers do not have enough control over the bottleneck links to enforce their desired policies. This paper attempts to resolve this conundrum by \emph{moving the bottleneck to the customer's edge}, such that appropriate scheduling and queue management policies can effectively enforced.

\radhika{lock: to be continued....}
