...
The vast literature on scheduling and queue management algorithms~\cite{diffserv, fair-queueing, sfq, pie, CoDel, fifoplus, virtualClocks, csfq, drr, red, ecn} clearly indicates the performance benefits of deploying such policies within the network. \radhika{a little more details} However, the Internet, at large, has been unable to enjoy these benefits for reasons discussed below. 
