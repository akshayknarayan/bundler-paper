...
<<eval:tput-delay:a,fig.showtext=TRUE,cache=TRUE,echo=FALSE,warning=FALSE,fig.width='\\columnwidth',fig.height=2.5>>=
library(ggplot2)
library(showtext)
font_add_google("Lato")
showtext_auto()

df <- read.csv("tputdelay.data", sep=" ")
...
@
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
<<eval:tput-delay:b,fig.showtext=TRUE,cache=TRUE,echo=FALSE,warning=FALSE,fig.width='\\columnwidth',fig.height=2.5>>=
library(ggplot2)
library(showtext)
font_add_google("Lato")
showtext_auto()
