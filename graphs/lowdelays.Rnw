...
#    ) +
   scale_colour_brewer(type="qual", palette=2,
       limit=c("copa_fqcodel", "nobundler_fifo"),
       labels=c(
           "copa_fqcodel" = "Bundler (FQ-CoDel)", 
           "nobundler_fifo" = "Baseline"
       ),
