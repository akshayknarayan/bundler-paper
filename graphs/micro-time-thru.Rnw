\begin{figure}
    \centering
<<micro:time-thru,cache=TRUE,echo=FALSE,warning=TRUE,verbose=TRUE,fig.width='\\columnwidth',fig.height=6>>=
...
p1 <- ggplot() + 
    ...
    scale_color_manual(name="", labels=c(windowed="Measured", true="Bottleneck"), values=c(true="#2c7bb6", windowed="#d7191c")) +
