...
When the \outbox receives a packet, it could send feedback back along the same path, including its IP subnet.
The \inbox could intercept these messages and configure the new bundle appropriately.
