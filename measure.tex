...
Use TCP sequence numbers is tempting, but retransmissions may confuse RTT measurements.
...
For $H$, we use the widely used Fowler/Noll/Vo (FNV) hash function~\cite{fnv-hash} is a non-cryptographic fast hash function with a low collision rate. In our experiments, 
