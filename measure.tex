...
When the \inbox updates the epoch size for a bundle, it sends an out-of-band message to the \outbox communicating the new value. To increase the resilience of our appraic
