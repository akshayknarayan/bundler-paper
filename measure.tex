...
left the \inbox (we address re-ordering in Section~\ref{s:measure:limitation:reorder}). \an{note about re-ordering is a little distracting and doesn't help explain approach} \radhika{that's what footnotes are for :)}
...
For examaple, \fc{is an example necessary?} \radhika{I found it useful, especially because I didn't understand what you mean by ``compatible'' in the line above. but i would like to discuss this further.}
